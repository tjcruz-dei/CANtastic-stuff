 ...
 * 
 *  Original version written By: Cory J. Fowler  December 20th, 2016
 *  Adapted for VAG OBD by Tjcruz, 2024
 *  Encoder support by Tjcruz, 2025
 *  
 */ 
...
//Encoder connected on pins 5,6
long oldPosition  = 0, newPosition, updateInt;
Encoder myEnc(5, 6);
...
void loop()
{
  ...
  //Mapeamento simples do encoder para referencial de RPM, Velocidade e pressão do turbo
  if ((millis()-updateInt)>25){
    updateInt=millis();
...
//    }
   ...
   //Serial.print("FUNCID ");
      ...
      long rpmRef=newPosition*25;
      txData[4] = byte((rpmRef & 63)*4);
      txData[3] = byte(rpmRef >> 6);
      tx = true;
      //Serial.println("ASKRPM"+String(millis()));
    }
      ...
      tx = true;
      //Serial.print("FUNCID");
      //Serial.println("ASKSPEED"+String(millis()));
    }
